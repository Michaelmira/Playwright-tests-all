...
test('Hacker News Test Suite', async ({ page }) => {
    ...
    // Assert that the first title element is visible and contains text
    ...
    totalTests++
    // Test 3.1: Locate, format and validate date
    ...
    // Assert that the last title element is visible and contains text
    ...
    totalTests++
    // Test 4: Check 100 posts that they are in order by date
